...
const description = "Portfolio professionnel orienté NOC : supervision, monitoring, réseaux, gestion d’incidents et sécurité opérationnelle, avec une évolution structurée vers le SOC.";
